...
import org.tensorflow.lite.examples.objectdetection.ollama.ChatRequest;
import org.tensorflow.lite.examples.objectdetection.ollama.ChatResponse;
import org.tensorflow.lite.examples.objectdetection.ollama.Messages;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendButton.setOnClickListener(v -> {
            ...
            ArrayList<Messages.Message> messagesCopy = new ArrayList<>((llamaMessages.messages));
            messagesCopy.add(new Messages.Message("user", sharedPreferences.getString(SYSTEM_PROMPT, "")));
            ChatRequest chatRequest = new ChatRequest(sharedPreferences.getString(MODEL_KEY, ""), messagesCopy,true);
